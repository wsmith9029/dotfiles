...
hl.bind("XF86MonBrightnessUp", hl.dsp.exec_cmd("./.config/waybar/scripts/brightness --inc"),
    { locked = true, repeating = true })
hl.bind("XF86MonBrightnessDown", hl.dsp.exec_cmd("./.config/waybar/scripts/brightness --dec"),
    { locked = true, repeating = true })
